...
app.post("/upload", upload.single("file"), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield FileModel.deleteOne({ fileKey }); // Remove previous document with the same fileKey
...
app.get('/documents', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const documents = yield FileModel.find({}); // Fetch only necessary fields
...
app.get('/documents/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const document = yield FileModel.findById(id); // Replace with your document fetching logic
        if (!document) {
